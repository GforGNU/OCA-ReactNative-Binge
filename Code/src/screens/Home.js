...
const styles = StyleSheet.create({
    ...
    seeMoreButton:{fontFamily: 'Bangers_400Regular',color: 'white', fontSize: 20, textAlign: 'center', backgroundColor: "#007FFF", borderRadius: 20  ,  paddingHorizontal: 15, paddingVertical: 10, overflow: 'hidden', height: 40 },
    textWhite: {color: '#fff'},
